...
export function useRequestForm (fn) {
    ...
    const {value: amount, errorMessage: amountError, handleBlur: amountBlur} = useField('amount',
        yup.number()
    ...
    return {
        ...
        status, fio, phone, amount,
        fioError, phoneError, amountError,
        fioBlur, phoneBlur, amountBlur
    }
}
